    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex space-x-4 min-w-full pb-6 pt-2 justify-end">
                ...
                <button class="sc-btn-primary">
                    <a href="{{ route('admin/markets/create') }}">
                        <i class="fa-solid fa-plus"></i>&nbsp;Add Market
                    </a>
                </button>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr class="hover table-group">
                                ...
                                <td class="table-item">
                                    ...
                                    @else
                                    <img src="../storage/img/random_market.png" width="30" />
                                    @endif
                                </td>
                                <td class="table-item">{{ $market->market_name }}</td>
                                <td class="table-item">{{ $market->email }}</td>
                                <td class="table-item">
                                    @php
                                    $dt = new DateTime($market->updated_at);
        ...
        <div class="sticky rounded-md bottom-0 bg-white p-3 bg-shadow w-full">
            <div class="flex justify-center space-x-3 lg:space-x-8">
                <button type="button" class="sc-btn-ghost"><a href="{{ url('admin/markets/edit/' . $checkboxticked[0]) }}"><i class="fa-solid fa-pen-to-square"></i>&nbsp;Edit</a></button>
            </div>
        </div>
