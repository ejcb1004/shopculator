<div>
    ...
    <form wire:submit.prevent="store" enctype="multipart/form-data">
        ...
        <x-jet-confirmation-modal wire:model="to_confirm">
            ...
            <x-slot name="content">
                Are you sure you want to save this subcategory's details?
            </x-slot>
    ...
    <div class="max-w-7xl mx-auto px-3 pb-4 sm:px-6 lg:px-8 pt-12">
        <div class="flex flex-row w-full h-16 items-center justify-center">
            <span class="tracking-wide text-gray-700 text-2xl font-bold">Edit Subcategory</span>
        </div>
                ...
                <form class="min-w-full max-w-lg justify-between">
                    <div class="mb-4">
                        <div class="w-full">
                            ...
                            <input wire:model="subcategory_name" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" type="text" placeholder="Subcategory Name">
                        </div>
                    </div>
                    <div class="mb-4">
                        <div class="w-1/3">
                            ...
                            <select wire:model="category_id" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
