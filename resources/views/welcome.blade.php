<x-app-layout>
    ...
    <div class="bg-[url('../../public/img/shopculator-bg.png')] bg-cover">
                ...
                <div class="flex flex-wrap -mx-4">
                    <div class="w-full px-4">
                        <div class="text-center mx-auto mb-12 lg:mb-20 max-w-[380px] sm:max-w-[510px] lg:max-w-[720px]">
                            <span class="font-semibold text-xl text-teal-600 mb-2 block">
                                App Features
                            </span>
                            <h2 class="font-bold text-3xl sm:text-4xl md:text-[40px] text-teal-700 mb-4">
                                How We Stand Out
                            </h2>
                            <span class="text-teal-700 text-lg">
                                Shopping has never been easier with Shopculator. Now you don't have to waste time
                                calculating your expenses and managing your budget by hand.
                            </span>
                        </div>
                    </div>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-2">
                    <div class="w-full">
                        <div class="flex flex-col items-center p-10 md:px-7 xl:px-10 rounded-[20px] bg-white shadow-md hover:shadow-lg">
                            ...
                            <h4 class="font-semibold text-xl text-teal-700 mb-3">
                                Budget Limiter
                            </h4>
