<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="footer">
                <button wire:click="$toggle('confirmingLogout')" wire:loading.attr="disabled" class="flex ml-1 px-6 py-1.5 text-gray-400 border-2 solid border-gray-400 rounded-full hover:bg-white hover:text-gray-300 hover:border-gray-300 hover:transition hover:duration-300">
                    {{ __('Cancel') }}
                </button>
